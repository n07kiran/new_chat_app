...
export const askGemini = async (msgs) => {
    ...
    const prompt1 = `Your given a conversation of a group chat. Each message is of the format,
    ...
    const prompt2 = `
    your supposed to understand the message and answer to the specific question which is asked by user.
    The Message specifying or containing @ai in the given content are supposed to be answered by you!
    Understand the chat and taking it as the base knowledge answer from your knowledge and the chat.
    Here is the full message : ${msgs}
    Conversation ends!
    Remember your in a conversation with human, So answer like human friendly answers`;
